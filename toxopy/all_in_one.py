...
cat = '/Users/Felis.catus/Desktop/all_in_one/daisy_chwo.csv'
owner = '/Users/Felis.catus/Desktop/all_in_one/daisy_oh.csv'
...
improve_dlc_output(cat, type='owner')
improve_dlc_output(owner, type='owner')
...
for s, w in zip(df['velocity'], idx):
    if s == 0:
        df = df.drop(w)
    elif s > 100:
        df = df.drop(w)
